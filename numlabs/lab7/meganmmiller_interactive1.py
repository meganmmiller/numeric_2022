...
def interactive1(grid, ngrid, dt, T, small=True):  # return eta  #Small now set to true
...
# set-up topography
    ...
    # plot contours
    plotit(grid, ngrid, dx, x, y, u, v, eta, Hu, Hv) #added Hu and Hv to plots
...
def plotit(grid, ngrid, dx, x, y, u, v, eta, Hu, Hv): #Added Hu and Hv
    ...
    #Adding plot of Hu and Hv to visualize how I changed the topography
    figH, (axHu, axHv)=plt.subplots(1,2, figsize=(10,5))
    axHu.contour(Hu)
    axHv.contour(Hv)
    axHu.set_title("Contours of Hu")
    axHv.set_title("Contours of Hv")
